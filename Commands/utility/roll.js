...
const { SlashCommandBuilder,EmbedBuilder, AttatchmentBuilder, bold } = require('discord.js');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const string = bold(`${interaction.member.displayName} , Rolled a ${sides}-sided die and got a ${roll} !`);
        console.log(string);
